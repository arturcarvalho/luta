...
function ImgSelector(props: PropsImgSelector) {
  return (
    <div className="flex items-center">
      <button className="mr-1" onClick={props.previous}>
        prev
      </button>
      <img
        ...
        alt={props.hero.name}
      />
      <button className="ml-1" onClick={props.next}>
        next
      </button>
    </div>
  );
...
export default function SelectScreen(props: Props) {
  return (
    <div className="bg-stone-200 m-auto h-full flex">
      <div className="mt-10">
        <div className="w-[600px] m-2 flex gap-x-8 justify-center items-center">
          <ImgSelector
            hero={props.leftHero}
